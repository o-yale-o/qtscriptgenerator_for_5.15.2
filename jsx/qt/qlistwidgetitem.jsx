...
{
    function constructor (listview : QListWidget, type : int);
    function constructor (icon : QIcon, text : string, listview : QListWidget, type : int);
    function constructor (text : string, listview : QListWidget, type : int);
