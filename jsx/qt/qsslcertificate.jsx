...
native class QSslCertificate
{
    ...
    static function importPkcs12 (device : QIODevice, key : QSslKey, cert : QSslCertificate, caCertificates : QSslCertificate[], passPhrase : QByteArray) : boolean;
    ...
    function issuerDisplayName () : string;
    ...
    function subjectDisplayName () : string;
