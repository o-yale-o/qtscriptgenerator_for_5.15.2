...
{
    function constructor (treeview : QTreeWidget, after : QTreeWidgetItem, type : int);
    function constructor (treeview : QTreeWidget, strings : string[], type : int);
    function constructor (treeview : QTreeWidget, type : int);
