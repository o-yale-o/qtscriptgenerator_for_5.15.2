...
native class QNetworkReply extends QIODevice
{
    ...
    static const TooManyRedirectsError : Qt_QNetworkReply_NetworkError;
    static const InsecureRedirectError : Qt_QNetworkReply_NetworkError;
    ...
    static const ContentConflictError : Qt_QNetworkReply_NetworkError;
    static const ContentGoneError : Qt_QNetworkReply_NetworkError;
    ...
    static const InternalServerError : Qt_QNetworkReply_NetworkError;
    static const OperationNotImplementedError : Qt_QNetworkReply_NetworkError;
    static const ServiceUnavailableError : Qt_QNetworkReply_NetworkError;
    static const UnknownServerError : Qt_QNetworkReply_NetworkError;
    ...
    var errorOccurred : QtJSXQt_QNetworkReply_NetworkErrorSignal;
    var finished : QtJSXSignal;
    var metaDataChanged : QtJSXSignal;
    var redirectAllowed : QtJSXSignal;
    var redirected : QtJSXQUrlSignal;
