...
native class QMatrix4x4
{
    ...
    function operator () (row : int, column : int) : number;
    ...
    function viewport (rect : QRectF) : void;
    function viewport (left : number, bottom : number, width : number, height : number, nearPlane : number, farPlane : number) : void;
}
