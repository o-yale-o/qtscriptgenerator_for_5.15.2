...
native class QSslError
{
    ...
    static const CertificateStatusUnknown : Qt_QSslError_SslError;
    static const OcspNoResponseFound : Qt_QSslError_SslError;
    static const OcspMalformedRequest : Qt_QSslError_SslError;
    static const OcspMalformedResponse : Qt_QSslError_SslError;
    static const OcspInternalError : Qt_QSslError_SslError;
    static const OcspTryLater : Qt_QSslError_SslError;
    static const OcspSigRequred : Qt_QSslError_SslError;
    static const OcspUnauthorized : Qt_QSslError_SslError;
    static const OcspResponseCannotBeTrusted : Qt_QSslError_SslError;
    static const OcspResponseCertIdUnknown : Qt_QSslError_SslError;
