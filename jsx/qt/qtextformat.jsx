...
native class QTextFormat
{
    ...
    static const HeadingLevel : Qt_QTextFormat_Property;
    static const BlockQuoteLevel : Qt_QTextFormat_Property;
    static const BlockCodeLanguage : Qt_QTextFormat_Property;
    static const BlockCodeFence : Qt_QTextFormat_Property;
    static const BlockMarker : Qt_QTextFormat_Property;
    ...
    static const FontFamilies : Qt_QTextFormat_Property;
    static const FontStyleName : Qt_QTextFormat_Property;
    ...
    static const TableBorderCollapse : Qt_QTextFormat_Property;
    ...
    static const TableCellTopBorder : Qt_QTextFormat_Property;
    static const TableCellBottomBorder : Qt_QTextFormat_Property;
    static const TableCellLeftBorder : Qt_QTextFormat_Property;
    static const TableCellRightBorder : Qt_QTextFormat_Property;
    static const TableCellTopBorderStyle : Qt_QTextFormat_Property;
    static const TableCellBottomBorderStyle : Qt_QTextFormat_Property;
    static const TableCellLeftBorderStyle : Qt_QTextFormat_Property;
    static const TableCellRightBorderStyle : Qt_QTextFormat_Property;
    static const TableCellTopBorderBrush : Qt_QTextFormat_Property;
    static const TableCellBottomBorderBrush : Qt_QTextFormat_Property;
    static const TableCellLeftBorderBrush : Qt_QTextFormat_Property;
    static const TableCellRightBorderBrush : Qt_QTextFormat_Property;
    static const ImageName : Qt_QTextFormat_Property;
    static const ImageTitle : Qt_QTextFormat_Property;
    static const ImageAltText : Qt_QTextFormat_Property;
    static const ImageWidth : Qt_QTextFormat_Property;
    static const ImageHeight : Qt_QTextFormat_Property;
    static const ImageQuality : Qt_QTextFormat_Property;
