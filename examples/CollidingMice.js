...
function Mouse(parent) {
    ...
    this.color = new QColor(Math.random()*256, Math.random()*256,
                            Math.random()*256);
    // Qt 5: QGraphicsItem::rotate() was removed; setRotation() is
    // equivalent here since the item's initial rotation is 0
...
Mouse.prototype.move = function() {
    ...
    // Qt 5: rotate(d) was cumulative; reproduce it with setRotation()
