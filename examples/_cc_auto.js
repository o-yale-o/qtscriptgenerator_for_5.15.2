...
var win = new Window();
win.show();
// QTimer.singleShot static is not bound; use a single-shot timer object.
var quitTimer = new QTimer();
quitTimer.singleShot = true;
quitTimer.timeout.connect(qApp, "quit()");
